...
CREATE TABLE orders(id SERIAL PRIMARY KEY, name VARCHAR(255), food_id INTEGER, party_id INTEGER, order_id INTEGER, party_name VARCHAR(255), manager_id INTEGER, no_charge BOOLEAN DEFAULT false );
